...
namespace YimMenu::Submenus
{
	    ...
	    Submenu::Submenu("Self", ICON_FA_USER)
	{
		...
		auto resistanceGroup = std::make_shared<Group>("Dirençler", 2);
		...
		movementGroup->AddItem(std::make_shared<BoolCommandItem>("walkstyle"_J));
		movementGroup->AddItem(std::make_shared<ConditionalItem>("walkstyle"_J, std::make_shared<ListCommandItem>("walkstyleselector"_J)));
		...
		resistanceGroup->AddItem(std::make_shared<BoolCommandItem>("bulletproof"_J));
		resistanceGroup->AddItem(std::make_shared<BoolCommandItem>("fireproof"_J));
		resistanceGroup->AddItem(std::make_shared<BoolCommandItem>("explosionproof"_J));
		resistanceGroup->AddItem(std::make_shared<BoolCommandItem>("collisionproof"_J));
		resistanceGroup->AddItem(std::make_shared<BoolCommandItem>("meleeproof"_J));
		resistanceGroup->AddItem(std::make_shared<BoolCommandItem>("waterproof"_J));
