...
namespace YimMenu::Submenus
{
	...
	static void Hotkeys()
	{
		ImGui::BulletText("Komut adını taşıyan düğmeye tıkla ve kısayolunu değiştirmek için bir tuşa bas");
		ImGui::BulletText("Bir komutun mevcut bir kısayolu varsa, düğmeye tıklamak kısayolu kaldırır");
