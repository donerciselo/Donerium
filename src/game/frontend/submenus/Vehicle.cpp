...
namespace YimMenu::Submenus
{
	    ...
	    Submenu::Submenu("Vehicle", ICON_FA_CAR)
	{
		...
		tools->AddItem(std::make_shared<BoolCommandItem>("autopilot"_J, "Oto Pilot"));
		tools->AddItem(std::make_shared<ConditionalItem>("autopilot"_J, std::make_shared<ListCommandItem>("autopilotspeedmode"_J, "Hız Modu")));
		tools->AddItem(std::make_shared<ConditionalItem>("autopilot"_J, std::make_shared<ListCommandItem>("autopilotdrivestyle"_J, "Sürüş Stili")));
		tools->AddItem(std::make_shared<ConditionalItem>("autopilot"_J, std::make_shared<BoolCommandItem>("autopilotweather"_J, "Hava Modu")));
		tools->AddItem(std::make_shared<ConditionalItem>("autopilot"_J, std::make_shared<BoolCommandItem>("autopilotnight"_J, "Gece Modu")));
		tools->AddItem(std::make_shared<ConditionalItem>("autopilot"_J, std::make_shared<BoolCommandItem>("autopilotescape"_J, "Polis Kaçış")));
		tools->AddItem(std::make_shared<ConditionalItem>("autopilot"_J, std::make_shared<BoolCommandItem>("autopilothud"_J, "HUD Gösterge")));
		tools->AddItem(std::make_shared<BoolCommandItem>("autopark"_J, "Oto Park"));
