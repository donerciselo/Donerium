...
namespace YimMenu::Submenus
{
	    ...
	    Submenu::Submenu("World", ICON_FA_GLOBE)
	{
		...
		auto trafficGroup = std::make_shared<Group>("Trafik");
		trafficGroup->AddItem(std::make_shared<BoolCommandItem>("trafficcontroller"_J));
		trafficGroup->AddItem(std::make_shared<ConditionalItem>("trafficcontroller"_J, std::make_shared<FloatCommandItem>("trafficdensity"_J)));
		trafficGroup->AddItem(std::make_shared<ConditionalItem>("trafficcontroller"_J, std::make_shared<FloatCommandItem>("peddensity"_J)));
		...
		main->AddItem(std::move(trafficGroup));
