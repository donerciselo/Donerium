...
namespace YimMenu
{
	static constexpr auto randomEventNames = std::to_array({"Uyuşturucu Aracı",
	    "Film Ekipmanları",
	    "Uyuyan Koruma",
	    "Egzotik İhracat",
	    "Katiller",
	    ...
	    "Dükkan Soygunu",
	    "Gooch",
	    "Weazel Plaza Çatışması",
	    "Zırhlı Kamyon",
	    "Ele Geçirilmiş Hayvanlar",
	    "Açığa Çıkan Hayaletler",
	    "Mutlu Bayramlar Tırı",
	    "Toplum Yardımı",
	    "Kaçış Sürücüsü",
	    "Uyuşturucu Hayatta Kalma",
	    "Sevgililer Hilesi",
	});
