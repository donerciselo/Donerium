...
namespace YimMenu
{
	DWORD Main(void*)
	{
		...
		LogHelper::Init("Donerium", FileMgr::GetProjectFile("./cout.log"));

		LOGF(INFO, "Welcome to Donerium! Build date: {} at {}", __DATE__, __TIME__);
		...
		Notifications::Show("Donerium", "Başarıyla yüklendi", NotificationType::Success);
